...
I2C_DMA_READ_NORMAL_WRITE_FUNC_DEF(vl53l8cx, VL53L8CX_I2C_HANDLE, uint16_t);
...
void HAL_I2C_MasterRxCpltCallback(I2C_HandleTypeDef *hi2c) {
    ...
    } else if (hi2c->Instance == VL53L8CX_I2C_HANDLE.Instance) {
        I2C_DMA_RX_COMPLETE_CALLBACK(vl53l8cx);
    }
}
...
void _I2C_Init() {
    ...
    I2C_DMA_READ_WRITE_SEM_INIT(vl53l8cx);
}