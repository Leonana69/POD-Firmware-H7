 ...
 * layer.
 */
typedef int8_t (*vl53l8_read_fptr_t)(uint16_t reg_addr, uint8_t *read_data, uint32_t len, void *intf_ptr);
typedef int8_t (*vl53l8_write_fptr_t)(uint16_t reg_addr, const uint8_t *read_data, uint32_t len, void *intf_ptr);
typedef uint16_t (*vl53l8_timestamp_fptr_t) ();
typedef void (*vl53l8_delay_ms) (uint32_t);
typedef struct
{
	...
	vl53l8_read_fptr_t read;
	vl53l8_write_fptr_t write;
	vl53l8_delay_ms delay;
	vl53l8_timestamp_fptr_t millis;
} VL53L8CX_Platform;
