...
void controllerPidPositionInit(void) {
    pidInit(&pid_x, 4.0f, 2.0f, 0.5f, POSITION_RATE, POS_OUTTER_LOOP_CUTOFF_FREQ, 1.0f, 0.8f);
    pidInit(&pid_y, 4.0f, 2.0f, 0.5f, POSITION_RATE, POS_OUTTER_LOOP_CUTOFF_FREQ, 1.0f, 0.8f);
